module.exports = {
  ...
  update: 'UPDATE blog_tbl SET title=?,author=?,content=?,about=?,origin=? where blog_id=?',
  delete: 'DELETE FROM blog_tbl WHERE blog_id=?',
  ...
  getOwner: 'select contributor from blog_tbl where blog_id=?',
