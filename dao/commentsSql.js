module.exports = {
  ...
  queryCommentsByUser: 'SELECT a.comment_id as commentId,a.from_user as fromUser,a.to_user as toUser,a.content, date_format(a.time, \'%Y-%m-%d %H:%i:%s\') as time,b.title from comments a left join blog_tbl b on a.blog_id=b.blog_id',
